        ...
        <div className="p-4 border-b border-panel-border bg-background/20">
          <form onSubmit={handleSubmit} className="relative">
            <textarea
              ...
              placeholder={isRunning ? 'Agent is working…' : 'Describe what you want to build or fix. ⌘/Ctrl+Enter to submit.'}
          ...
          {activeTaskId && (
            <div className="mt-3 p-3 rounded-lg border border-primary/20 bg-primary/10 flex items-center justify-between animate-in fade-in">
